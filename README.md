...
| 卒業提出（2026年8月3日予定） | ✅ 対応完了（結合テスト・セキュリティレビュー・ドキュメント整備・ライセンス選定） |
| Phase 4: デジカメ等からの取り込み機能 | 🔲 卒業後の継続課題 |
...
助成金等の都合により、まず2026年8月3日の卒業提出を優先する形でスコープを整理しています（2026-07-25改訂）。

**卒業提出までに対応するもの:**

- ~~iMacからのエクスポート手順書の整備~~ ✅ 完了（[docs/01-export-macos.md](docs/01-export-macos.md)、2026-07-26）
- ~~Windows側の導入・アーカイブフォルダの手動パス指定の案内~~ ✅ 完了（[docs/02-import-and-view-windows.md](docs/02-import-and-view-windows.md)、2026-07-26）
- ~~ここまでの実装分に対する結合テスト~~ ✅ 完了（2026-07-26）
- ~~ここまでの実装分に対するセキュリティレビュー~~ ✅ 完了（HIGH2件検出・修正、2026-07-25）
- ~~ライセンス選定~~ ✅ 完了（GPL v3.0を採用、2026-07-25）

**卒業後の継続課題（このマイルストーンでは対象外）:**
